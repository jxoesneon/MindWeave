...
import '../../features/frequencies/frequencies_screen.dart';
            ...
            children: [
              ...
              _IconButton(
                ...
                onPressed: () => Navigator.push(
                  context,
                  MaterialPageRoute(builder: (_) => const FrequenciesScreen()),
                ),
              ),
              _IconButton(
...
''';
  ...
  void _showLibrary(BuildContext context) {
    showModalBottomSheet(
      ...
      isScrollControlled: true,
      backgroundColor: Colors.transparent,
      builder: (context) => const LibraryScreen(isModal: true),
    );
  }
